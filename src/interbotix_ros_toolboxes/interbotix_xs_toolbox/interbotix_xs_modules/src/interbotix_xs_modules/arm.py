...
class InterbotixArmXSInterface(object):
    ...
    def publish_positions(self, positions, moving_time=None, accel_time=None, blocking=True):
        ...
        # self.T_sb = mr.FKinSpace(self.robot_des.M, self.robot_des.Slist, self.joint_commands)
        self.T_sb = None  # This prevents the code from calculating FK at every step which delays teleoperation.
    ...
    # def get_joint_postion(self):
    #     joint_states = [self.core.joint_states.position[self.core.js_index_map[name]] for name in self.group_info.joint_
    #     return  joint_states
